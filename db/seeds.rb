...
Review.create(book_id: 7, user_id: 1, rating: 3, review: "A spellbinding story.")
Review.create(book_id: 8, user_id: 2, rating: 3, review: "Truly amazing!")
...
Review.create(book_id: 4, user_id: 1, rating: 3, review: "An amazingly gifted writer.")
Review.create(book_id: 5, user_id: 2, rating: 3, review: "A new classic.")
