...
Review.create(book_id: 3, user_id: 3, rating: 3, review: "Great book, but not very compelling.")
Review.create(book_id: 4, user_id: 1, rating: 5, review: "An excellent read.")
Review.create(book_id: 5, user_id: 2, rating: 4, review: "Such a fun book.")
...
Review.create(book_id: 8, user_id: 2, rating: 4, review: "Truly amazing!")
Review.create(book_id: 9, user_id: 3, rating: 3, review: "Not my favorite book ever. ")
Review.create(book_id: 10, user_id: 1, rating: 5, review: "I recommend this book to all my friends.")
...
Review.create(book_id: 15, user_id: 3, rating: 3, review: "Not for me.")
Review.create(book_id: 1, user_id: 1, rating: 5, review: "Beyond compare.")
Review.create(book_id: 2, user_id: 2, rating: 4, review: "A true delight.")
...
Review.create(book_id: 6, user_id: 3, rating: 3, review: "Needs some edits.")
Review.create(book_id: 7, user_id: 1, rating: 5, review: "I already read this three times.")
...
Review.create(book_id: 12, user_id: 3, rating: 3, review: "Innovative")
Review.create(book_id: 13, user_id: 1, rating: 5, review: "One of my favorites of all time.")
